...
Now that the implementation of the algorithm is finished, all that's left is to perform some more tests, write some examples, polish the docs and include it in 'dbnR'. The final performance is quite good, and I gained some valuable insights on R6 objects and parallelization in R and C++.
